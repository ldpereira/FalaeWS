 ...
 */
package com.falae.falaews;

import com.falae.falaews.model.Database;
import com.falae.falaews.model.Group;
import com.falae.falaews.model.Message;
import com.falae.falaews.model.ReportMensagem;
import com.falae.falaews.model.ReportUserGroup;
import com.falae.falaews.model.User;
...
public class WebService {
    ...
    public Response getMessages(@PathParam("group") String group) {
        ...
        return Response.status(200)
                ...
                .header("Access-Control-Allow-Methods", "GET, POST, PUT, DELETE, OPTIONS, HEAD")
                .header("Access-Control-Max-Age", "1209600")
                .entity(new GenericEntity<List<Message>>(list) {}).build();
    }
    ...
    public Response getUsuariosGrupos() {
        return Response.status(200)
            ...
            .header("Access-Control-Allow-Methods", "GET, POST, PUT, DELETE, OPTIONS, HEAD")
            .header("Access-Control-Max-Age", "1209600")
            .entity(new GenericEntity<List<ReportUserGroup>>(Database.getInstance().getUsuariosGrupos()) {}).build();
    }
	...
	public Response getMensagensGrupos() {
        return Response.status(200)
            ...
            .header("Access-Control-Allow-Methods", "GET, POST, PUT, DELETE, OPTIONS, HEAD")
            .header("Access-Control-Max-Age", "1209600")
            .entity(new GenericEntity<List<ReportMensagem>>(Database.getInstance().getMensagensGrupos()) {}).build();
    }
	...
	public Response getMensagensUsuarios() {
        return Response.status(200)
            ...
            .header("Access-Control-Allow-Methods", "GET, POST, PUT, DELETE, OPTIONS, HEAD")
            .header("Access-Control-Max-Age", "1209600")
            .entity(new GenericEntity<List<ReportMensagem>>(Database.getInstance().getMensagensUsuarios()) {}).build();
    }
}
